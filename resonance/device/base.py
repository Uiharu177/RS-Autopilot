"""设备抽象接口：ADB / MuMu IPC 的统一基类。

  要求子类实现：screenshot()、input_tap()、input_swipe()、kill()。
  dsize/ratio/safe_area 由连接时自动设置。
"""
...
class IADB(ABC):
    ...
    def check_status(self) -> bool:
        """Verify connection is alive. Return False if reconnection needed."""
        pass
